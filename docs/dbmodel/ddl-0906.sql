-- 운항정보
ALTER TABLE P0_TRVL
	DROP FOREIGN KEY FK_P0_AP_TO_P0_TRVL2; -- 공항정보 -> 운항정보

-- 운항정보
ALTER TABLE P0_TRVL
	DROP FOREIGN KEY FK_P0_AP_TO_P0_TRVL; -- 공항정보 -> 운항정보2

-- 예약
ALTER TABLE P0_RSV
	DROP FOREIGN KEY FK_P0_MEMB_TO_P0_RSV; -- 회원 -> 예약

-- 예약
ALTER TABLE P0_RSV
	DROP FOREIGN KEY FK_P0_TRVL_TO_P0_RSV; -- 운항정보 -> 예약

-- 좌석정보
ALTER TABLE P0_GRD
	DROP FOREIGN KEY FK_P0_TRVL_TO_P0_GRD; -- 운항정보 -> 좌석정보
...
-- 공항정보
ALTER TABLE P0_AP
	DROP PRIMARY KEY; -- 공항정보 기본키

-- 운항정보
ALTER TABLE P0_TRVL
	DROP PRIMARY KEY; -- 운항정보 기본키
...
-- 좌석정보
ALTER TABLE P0_GRD
	DROP PRIMARY KEY; -- 좌석정보 기본키

-- 회원 유니크 인덱스
DROP INDEX UIX_P0_MEMB ON P0_MEMB;

-- 예약 유니크 인덱스
DROP INDEX UIX_P0_RSV ON P0_RSV;

-- 좌석정보 유니크 인덱스
DROP INDEX UIX_P0_GRD ON P0_GRD;
